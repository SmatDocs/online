...
bool AIChatSession::handleAction(const std::string& firstLine)
{
    ...
    std::string requestUrl = buildOpenAICompatibleEndpoint(std::move(baseUrl), "/chat/completions");
...
ImageGenRequest AIChatSession::createImageGenRequest(const std::string& prompt)
{
    ...
    req.requestUrl = buildOpenAICompatibleEndpoint(std::move(baseUrl), "/images/generations");
